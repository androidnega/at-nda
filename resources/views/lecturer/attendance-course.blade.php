...
(function () {
    ...
    // Generic ?focus_week=<id> deep-link: expand & scroll to a named
    // week card. Used by future routes that want to land directly on
    // a specific week (no roll-call dependency).
