...
<head>
    ...
    <title>Lecturer Login - {{ config('app.name') }}</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-800">Lecturer Login</h1>
            ...
            @endif
            <form action="{{ route('lecturer.login') }}" method="POST" class="space-y-4">
                @csrf
                <div>
