...
<div class="mb-6">
    ...
    <p class="text-gray-500 text-sm mt-1">Creates a staff login for the admin dashboard. Teaching staff are added under <a href="{{ route('dashboard.lecturers.index') }}" class="text-primary hover:underline">Lecturers</a> (no password).</p>
</div>
