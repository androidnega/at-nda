...
return new class extends Migration
{
    ...
    {
        $universityId = DB::table('universities')->where('name', 'Takoradi Technical University')->value('id');
        if (! $universityId) {
        ...
        $engId = $faculties['Faculty of Engineering'] ?? null;
        $appSciId = $faculties['Faculty of Applied Sciences'] ?? null;
        $busId = $faculties['Faculty of Business Studies'] ?? null;
        $builtId = $faculties['Faculty of Built and Natural Environment'] ?? null;
        $artsId = $faculties['Faculty of Applied Arts and Technology'] ?? null;
